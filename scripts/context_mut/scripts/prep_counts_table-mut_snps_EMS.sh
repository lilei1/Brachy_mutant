...
VCF="/home/morrellp/llei/context_test/Brachy/mutant/EMS_filter_plate.0_24.gatk.hf.sc.mafgt0.01.recode.vcf.gz"
...
OUT_DIR="/panfs/jay/groups/9/morrellp/llei/context_test/Brachy/mutant/results/EMS_mutant"
