...
source activate /panfs/jay/groups/9/morrellp/llei/.conda/envs/mut_motif_env/
# Load shared functions
source /panfs/jay/groups/9/morrellp/llei/context_test/Brachy/scripts/prep_counts_functions.sh

# User provided input arguments
VCF="/home/morrellp/llei/context_test/Brachy/mutant/NaN_filter_plate.0_24.gatk.hf.sc.recode.vcf.gz"
...
OUT_DIR="/panfs/jay/groups/9/morrellp/llei/context_test/Brachy/mutant/results/NaN_mutant"
