...
VCF="/home/morrellp/llei/context_test/Brachy/mutant/filter_rare_variants_SNPs.recode.vcf.gz"
...
OUT_DIR="/panfs/jay/groups/9/morrellp/llei/context_test/Brachy/mutant/results/rare_natural"
