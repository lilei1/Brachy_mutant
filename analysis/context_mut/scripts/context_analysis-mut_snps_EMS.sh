...
COMBINED_COUNTS_FILE="/panfs/jay/groups/9/morrellp/llei/context_test/Brachy/mutant/results/EMS_mutant/counts_tables/combined_counts_EMS_filter_plate.0_24.gatk.hf.sc.mafgt0.01.recode.winFlank15bp.txt"
# List of counts separated by mutation direction
COUNTS_LIST="/panfs/jay/groups/9/morrellp/llei/context_test/Brachy/mutant/results/EMS_mutant/counts_tables/separate_counts_file_list.txt"
# Parent output directory (subdirectories will automatically be created)
OUT_DIR="/panfs/jay/groups/9/morrellp/llei/context_test/Brachy/mutant/results/EMS_mutant/mutation_motif/combined_counts_EMS_filter_plate.0_24.mafgt0.01.SNPs"
