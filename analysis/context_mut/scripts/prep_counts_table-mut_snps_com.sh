...
VCF="/home/morrellp/llei/context_test/Brachy/mutant/filter_common_variants_SNPs.recode.vcf.gz"
...
OUT_DIR="/panfs/jay/groups/9/morrellp/llei/context_test/Brachy/mutant/results/com_natural"
