...
COMBINED_COUNTS_FILE="/panfs/jay/groups/9/morrellp/llei/context_test/Brachy/mutant/results/com_natural/counts_tables/combined_counts_filter_common_variants_SNPs.recode.winFlank15bp.txt"
# List of counts separated by mutation direction
COUNTS_LIST="/panfs/jay/groups/9/morrellp/llei/context_test/Brachy/mutant/results/com_natural/counts_tables/separate_counts_file_list.txt"
# Parent output directory (subdirectories will automatically be created)
OUT_DIR="/panfs/jay/groups/9/morrellp/llei/context_test/Brachy/mutant/results/com_natural/mutation_motif/combined_counts_com_natural.SNPs"
...
COUNTS_BN="com.natural.winFlank15bp"
