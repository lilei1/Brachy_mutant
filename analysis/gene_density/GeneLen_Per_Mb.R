...
capture <- read.table("reorder_SNPs_EMS.classified", header=F)
chr_sizes <- read.table("/global/cfs/cdirs/plantbox/llei/bscratch/llei2019/Bd21_3_mutant/circos/gene_density/Bd21-3.chrom.sizes", header=T)
